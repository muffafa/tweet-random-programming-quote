...
import { mdiCircleSmall, mdiClose } from "@mdi/js";
...
const Banner: React.FC<Props> = ({ children, onClick }) => {
  return (
    <div className="bg-gradient-to-b from-twitter-500 to-twitter-900 flex gap-x-6">
    ...
    // <div
    //   className="w-full relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1 z-0"
    // >
    //   <svg
    //     viewBox="0 0 577 310"
    //     aria-hidden="true"
    ...
    //     >
    //       Go To Repo <span aria-hidden="true">&rarr;</span>
    //     </a>
    //   </div>
    //   <div className="flex flex-1 justify-end">
    //     <a
    //       id="banner-button"
    //       className="-m-3 p-3 cursor-pointer focus-visible:outline-offset-[-4px]"
    //     >
